...
namespace ConsoleApp1
{
     class Program
     {
          ...
          static void Main(string[] args)
          {
               ...
               string key = "bigkeyworkdsforheasdasdasdadasd"; //key is optional, if not specify then the system will generate one. can be empty or null value
                /*
                    //encrypt
                    Encryption(input);
            ...
            */
              ...
              key = "HACK";
               ...
               ColumnarTransposition columnarTransposition = new ColumnarTransposition(input, key);
               columnarTransposition.PrintMessageMatrix();
               columnarTransposition.PrintColumnarMatrix();
               columnarTransposition.PrintTransposeMatrixMatrix();
               Console.WriteLine("--------Decrypted--------");
               String result= columnarTransposition.GetMessage(columnarTransposition.encryptionResult);
               String result2 = columnarTransposition.GetMessage();
